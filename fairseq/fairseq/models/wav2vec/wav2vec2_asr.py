...
class Wav2Vec2AsrConfig(FairseqDataclass):
    ...
    normalize: bool = field(default_factory=lambda: II("task.normalize"))
    update_alibi: bool = True
    data: str = field(default_factory=lambda: II("task.data"))
    ...
    ddp_backend: str = field(default_factory=lambda: II("distributed_training.ddp_backend"))
...
class Wav2Vec2Seq2SeqConfig(Wav2Vec2AsrConfig):
    ...
    autoregressive: bool = field(default_factory=lambda: II("task.autoregressive"))
