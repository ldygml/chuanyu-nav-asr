...
class SpeechDLMConfig(FairseqDataclass):
    ...
    add_bos_token: bool = field(default_factory=lambda: II("task.add_bos_token"))
    tokens_per_sample: int = field(default_factory=lambda: II("task.tokens_per_sample"))
    max_target_positions: Optional[int] = field(default_factory=lambda: II("task.max_target_positions"))
    tpu: bool = field(default_factory=lambda: II("common.tpu"))
    duration_prediction: str = field(default_factory=lambda: II("task.duration_prediction"))
    delayed_duration_target: str = field(default_factory=lambda: II("task.delayed_duration_target"))
    main_and_cross_weights: str = field(default_factory=lambda: II("criterion.main_and_cross_weights"))
