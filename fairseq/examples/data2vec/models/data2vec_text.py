...
class Data2VecTextConfig(FairseqDataclass):
    max_positions: int = field(default_factory=lambda: II("task.tokens_per_sample"))
    ...
    ema_anneal_end_step: int = field(default_factory=lambda: II("optimization.max_update"))
